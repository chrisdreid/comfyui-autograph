...
## Methodology
Cross-referenced every documented API feature from `docs/*.md` and [FEATURES.md](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/FEATURES.md) against:
...
| [to_json()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#1756-1758) + round-trip | — | 1.16, 1.17 | |
| [save()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#200-211) → reload | — | 1.18 | |
| Tab completion: [dir(flow.nodes)](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#1045-1058), [dir(api.KSampler)](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#1045-1058) | advanced.md | 1.20, 1.21 | |
| [Workflow()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#2025-2117) → ApiFlow | convert.md | 2.1 | |
| MarkdownNote stripping | convert.md | 2.2 | |
| ApiFlow dot-access + path access | load-vs-convert.md | 2.3, 2.4 | |
| [convert_with_errors()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#1936-1978) | error-handling.md | 2.6 | Basic only |
| [_meta](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#459-462) access + set + survive to_json | mapping.md | 2.7–2.9 | |
| WidgetValue `.choices()`, `.tooltip()`, `.spec()` | advanced.md | 2.14–2.16 | |
| [find(type=)](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#1146-1150) exact + case-insensitive | advanced.md | 3.1, 3.2 | |
| [find(type=re.compile(...))](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#1146-1150) regex | advanced.md | 3.3 | |
| [find(title=)](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#1146-1150) + regex | advanced.md | 3.4, 3.5 | |
| [find(key=value)](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#1146-1150) AND + OR | advanced.md | 3.6, 3.7 | |
| [find(node_id=)](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#1146-1150) | advanced.md | 3.8 | |
| `.path()` / `.address()` | advanced.md | 3.9, 3.10 | |
| `api.find(class_type=)` + regex | advanced.md | 3.11, 3.12 | |
| `api.by_id()` | — | 3.13 | |
| [map_strings()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#144-203) literal | map-strings-and-paths.md | 4.1 | |
| [force_recompute()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#255-295) | force-recompute.md | 4.5 | |
| [api_mapping()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#325-463) callback + overwrite | mapping.md | 4.7, 4.8 | |
...
| [__dir__](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#1045-1058) subprocess isolation (ApiFlow, NodeSet, NodeRef) | advanced.md | test_dir_and_widget_introspection.py | 18 |
...
| Schema-aware drilling ([seed](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/examples/unittests/test_flow_drilling.py#22-26) requires node_info) | advanced.md | test_flow_drilling.py | 6 |
| [fetch_node_info()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#449-451) (offline + error cases) | node-info-and-env.md | test_flow_drilling.py | 2 |
...
| [map_strings()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#144-203) regex + rules + [map_paths()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#205-253) | map-strings-and-paths.md | test_map_helpers.py | 13 |
| MarkdownNote stripping (fixture-based) | convert.md | test_markdownnote_strip.py | 2 |
| `AUTOGRAPH_MODEL_LAYER` env switch | node-info-and-env.md | test_model_layer_env_switch.py | 4 |
...
| [convert_with_errors()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#1936-1978) with invalid/partial scenarios | error-handling.md | test_error_handling.py | 5 (script) |
...
| [comfyui_available()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/convert.py#560-580) helper | execute.md | Only in docs-test preamble |
...
| `AUTOGRAPH_NODE_INFO_SOURCE` env var effects | node-info-and-env.md | Partial in test_nodeinfo_resolver_tokens |
...
| Metadata-driven targeting (`extra.autograph.meta.nodes`) | mapping.md | Not tested |
...
| `convert_callbacks` parameter on [Workflow()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/models.py#2025-2117) | mapping.md | Not tested |
| [api_mapping()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#325-463) with `win_to_linux` path pattern | mapping.md | Callback tested, not path patterns |
...
| [map_strings()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#144-203) with [rules](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/examples/unittests/test_map_helpers.py#23-46) filtering | map-strings-and-paths.md | In test_map_helpers, not in main.py |

---

## docs-test.py Coverage

The [docs-test.py](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/examples/code/docs-test.py) harness parses fenced code blocks in all `docs/*.md` files and:
- **Python blocks**: [compile()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/map.py#53-60) (syntax check) always; optionally [exec()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#463-502) in a sandbox
- **Bash blocks**: optionally runs safe CLI invocations
- **JSON blocks**: `json.loads()` and prints summary

It creates a sandbox with sample [workflow.json](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/examples/workflows/workflow.json), `workflow-api.json`, `node_info.json`, and a sample PNG. Blocks marked `# api` are candidates for execution. Blocks that reference [server_url](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/convert.py#582-601) or `localhost` are gated behind `--mode online`.
...
Current [main.py](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/examples/unittests/main.py) HTML report shows:
...
- Output/return values (e.g., what [find()](file:///home/chris/WORK/ComfyUI/ComfyUI-autograph/autograph/flowtree.py#1146-1150) returned, what the converted ApiFlow looks like)
...
- Metadata-driven targeting (`extra.autograph.meta.nodes`)
